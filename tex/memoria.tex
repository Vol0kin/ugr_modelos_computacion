...
int main(int argc, char *argv[]) {
	...
	\subsection{Práctica 3}
		...
		\sol \par
		a) El autómata quedaría de la siguiente forma:
		...
		\begin{itemize}
			...
			la cadena que se buscaba.
		\end{itemize}
		
		b) El autómata quedaría de la siguiente forma:
		...
		c) El autómata quedaría de la siguiente forma:
