...
int main(int argc, char *argv[]) {
	...
	\subsection{Práctica 4}
		...
		Como se puede observar, el estado $q_4$ es distinguible a todos los otros porque es el único que no es final. Los
		demás, de momento, son indistinguibles, así que se irán comprobando por partes. \par
